...
async function loadPage(document: any, pageNum: number): Promise<Page> {
  ...
  /*
    ...
    for this reason, we:
      ...
      https://via.hypothes.is/https://www.adobe.com/content/dam/acom/en/devnet/pdf/pdfs/
      pdf_reference_archives/PDFReference.pdf#annotations:SVudloF5EemLBgPm0gmY3Q
  */
