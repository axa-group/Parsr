                    ...
                    if (features[0] <= 9.980000019073486) {
                        ...
                        if (features[3] <= 0.5) {
                            if (features[0] <= 10.410000324249268) {
                                ...
                                if (features[0] <= 11.75) {
                                    if (features[0] <= 10.980000019073486) {
                                        classes[0] = 0; 
                                        classes[1] = 0; 
                                        classes[2] = 11; 
                                        classes[3] = 0; 
                            ...
                            if (features[2] <= 1.5) {
                                ...
                                if (features[0] <= 10.489999771118164) {
                                    if (features[2] <= 2.5) {
                                        classes[0] = 0; 
                                        classes[1] = 0; 
                                        classes[2] = 7; 
                            ...
                            if (features[0] <= 14.195000171661377) {
                                ...
                                if (features[0] <= 19.0) {
                                    if (features[0] <= 17.56999969482422) {
                                        if (features[0] <= 15.779999732971191) {
                                            classes[0] = 4; 
                                            classes[1] = 3; 
                                            classes[2] = 1; 
                                            classes[3] = 0; 
                    ...
                    if (features[2] <= 1.5) {
                        ...
                        if (features[0] <= 24.395000457763672) {
                            if (features[1] <= 0.5) {
                                ...
                                if (features[0] <= 20.520000457763672) {
                                    classes[0] = 1; 
                                    classes[1] = 0; 
                                    classes[2] = 0; 
                                    classes[3] = 0; 
                            ...
                            if (features[0] <= 48.920000076293945) {
                                if (features[0] <= 38.96500015258789) {
                                    if (features[0] <= 35.46999931335449) {
